...
<div class="space-y-6">
    ...
    <div class="flex items-center">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Add Product Brand</h1>
            <p class="mt-1 text-sm text-gray-500">Create a new product brand</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white shadow rounded-lg">
        <form method="POST" action="{{ route('product-brands.store') }}" class="space-y-6 p-6">
            @csrf
