...
@section('title', $pageTitle ?? 'Edit Company Settings')
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="email" 
                                       ...
                                       value="{{ old('email_secondary', $setting->email_secondary) }}">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div>
                        ...
                        <select class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('currency') border-red-300 @enderror" 
                                id="currency" 
                                name="currency">
                            <option value="MUR" {{ old('currency', $setting->currency) == 'MUR' ? 'selected' : '' }}>MUR (Mauritian Rupee)</option>
                            ...
                            <option value="GBP" {{ old('currency', $setting->currency) == 'GBP' ? 'selected' : '' }}>GBP (British Pound)</option>
                        </select>
                        @error('currency')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('timezone') border-red-300 @enderror" 
                                id="timezone" 
                                name="timezone">
                            <option value="Indian/Mauritius" {{ old('timezone', $setting->timezone) == 'Indian/Mauritius' ? 'selected' : '' }}>Indian/Mauritius</option>
