...
<div class="space-y-6">
    ...
    <div class="flex items-center">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Payment Type</h1>
            <p class="mt-1 text-sm text-gray-500">Update payment type information</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white shadow rounded-lg">
        <form method="POST" action="{{ route('payment-types.update', $paymentType) }}" class="space-y-6 p-6">
            @csrf
            @method('PUT')
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $paymentType->name) }}" 
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" 
                                  ...
                                  placeholder="Optional description of this payment type">{{ old('description', $paymentType->description) }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $paymentType->display_order) }}" 
                    ...
                    <div>
                        ...
                        <select name="status" id="status" 
                            ...
                            <option value="1" {{ old('status', $paymentType->status) == 1 ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ old('status', $paymentType->status) == 0 ? 'selected' : '' }}>Inactive</option>
                        </select>
                        @error('status')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="mt-6">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_default" id="is_default" value="1" 
                               {{ old('is_default', $paymentType->is_default) ? 'checked' : '' }}
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" 
                    ...
                    <i class="-ml-1 mr-2 fa-solid fa-save"></i>
                    Update Payment Type
                </button>
            </div>
        </form>
