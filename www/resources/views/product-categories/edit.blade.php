...
<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg">
        <form method="POST" action="{{ route('product-categories.update', $productCategory) }}" class="space-y-6 p-6">
            @csrf
            @method('PUT')
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $productCategory->sort_order ?? 0) }}" 
                               min="0"
