        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($uoms as $uom)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $uom->name }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <span class="font-semibold text-blue-600">{{ $uom->units_per_uom }}</span> pieces
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-500">{{ Str::limit($uom->description, 40) }}</td>
