...
@section('description', 'Edit role details and permissions')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                      ...
                                      placeholder="Describe the role's responsibilities and scope">{{ old('description', $role->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Role Status -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Role Information</label>
                            <div class="bg-gray-50 rounded-lg p-4 space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-medium">{{ $role->users->count() }} users</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-500">Created:</span>
                                    <span class="text-sm font-medium">{{ $role->created_at->format('M d, Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
